...
final class ProductListViewModelIntegrationTest: XCTestCase {
    ...
    func testGetListSucces() async throws {
        ...
        let listReference: [ProductListItem] = [
            ...
            ProductListItem(id: "MCO8721617", name: "iPhone 6 32 GB oro", image: "https://mla-s1-p.mlstatic.com/754809-MLA44155886493_112020-F.jpg"),
        ...
        //Este test puede fallar debido a que constantemente se agregan productos a la base de datos
    ...
    func testNotFoundNameProduct() async{
        ...
        XCTAssertEqual(sut.errorMessage, "No hay ningún producto con el nombre: \(query).")
